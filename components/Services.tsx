...
const services = [
  ...
  {
    icon: <Beaker className="w-5 h-5 md:w-6 md:h-6" />,
    title: "R&D",
...
const Services: React.FC = () => {
  return (
    <section id="services" className="relative py-12 md:py-20 px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 justify-items-center">
          {services.map((service, index) => (
            <motion.div
              ...
              className="group relative p-6 md:p-8 rounded-2xl bg-white/5 border border-white/10 hover:bg-white/10 hover:border-bright-accent/30 transition-all duration-300 backdrop-blur-sm overflow-hidden w-full max-w-sm"
            >
              ...
              <div className="relative z-10">
                <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-gradient-to-br from-purple-500/20 to-blue-500/20 border border-white/10 flex items-center justify-center text-purple-300 mb-4 md:mb-6 group-hover:scale-110 transition-transform duration-300">
                  {service.icon}
                </div>
                <h3 className="text-lg md:text-xl font-bold mb-2 md:mb-3 text-white group-hover:text-purple-200 transition-colors">
                  {service.title}
                </h3>
